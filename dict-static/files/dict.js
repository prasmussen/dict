...
var _sporto$erl$Erl_Query$decodeUri = function (_p10) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		_elm_lang$http$Http$decodeUri(_p10));
};
var _sporto$erl$Erl_Query$valueParser = A2(
...
var _sporto$erl$Erl_Query$keyParser = A2(
	_elm_tools$parser$Parser$keep,
	_elm_tools$parser$Parser$oneOrMore,
	function (c) {
		return (!_elm_lang$core$Native_Utils.eq(
...
var _sporto$erl$Erl_Query$kvParser = A2(
	...
	A2(
		...
		A2(
			...
			A2(
				...
				A2(_elm_tools$parser$Parser$map, _sporto$erl$Erl_Query$decodeUri, _sporto$erl$Erl_Query$keyParser)),
			_elm_tools$parser$Parser$symbol('=')),
		A2(_elm_tools$parser$Parser$map, _sporto$erl$Erl_Query$decodeUri, _sporto$erl$Erl_Query$valueParser)),
...
var _sporto$erl$Erl_Query$parser = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_elm_tools$parser$Parser_ops['|='],
			A2(
				...
				_elm_tools$parser$Parser$symbol('?')),
			A2(_elm_tools$parser$Parser$repeat, _elm_tools$parser$Parser$oneOrMore, _sporto$erl$Erl_Query$kvParser)),
		_1: {
			ctor: '::',
			_0: _elm_tools$parser$Parser$succeed(
				{ctor: '[]'}),
...
var _sporto$erl$Erl_Query$parse = function (input) {
	return A2(_elm_tools$parser$Parser$run, _sporto$erl$Erl_Query$parser, input);
};

var _sporto$erl$Erl$hashParser = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_elm_tools$parser$Parser_ops['|.'],
...
var _sporto$erl$Erl$pathnameParser = A2(
	_elm_tools$parser$Parser$keep,
...
var _sporto$erl$Erl$portParser = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: A2(
...
var _sporto$erl$Erl$hostParser = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_elm_tools$parser$Parser$keep,
...
var _sporto$erl$Erl$protocolParser = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: A3(
			...
			A2(_elm_tools$parser$Parser$keep, _elm_tools$parser$Parser$oneOrMore, _elm_lang$core$Char$isLower),
...
var _sporto$erl$Erl$new = {
	...
	host: '',
	pathname: '',
	port_: _elm_lang$core$Maybe$Nothing,
	query: {ctor: '[]'},
	hash: ''
};
var _sporto$erl$Erl$queryToString = function (url) {
	var encoded = A2(
		...
		A2(
			...
			url.query));
	return _elm_lang$core$List$isEmpty(url.query) ? '' : A2(_elm_lang$core$Basics_ops['++'], '?', encoded);
};
var _sporto$erl$Erl$hashToString = function (url) {
	return _elm_lang$core$String$isEmpty(url.hash) ? '' : (A2(_elm_lang$core$String$startsWith, '#', url.hash) ? url.hash : A2(_elm_lang$core$Basics_ops['++'], '#', url.hash));
};
var _sporto$erl$Erl$decodeSymbol = function (symbol) {
	var encoded = _elm_lang$http$Http$encodeUri(symbol);
	return A3(
		_elm_lang$core$Regex$replace,
		_elm_lang$core$Regex$All,
		_elm_lang$core$Regex$regex(encoded),
		function (_p3) {
			return symbol;
		});
};
var _sporto$erl$Erl$pathnameToString = function (url) {
	var leadingSlash = A2(_elm_lang$core$String$startsWith, '/', url.pathname) ? '' : '/';
	var encoded = A2(
		_sporto$erl$Erl$decodeSymbol,
		'/',
		_elm_lang$http$Http$encodeUri(url.pathname));
	return _elm_lang$core$String$isEmpty(url.pathname) ? '' : A2(_elm_lang$core$Basics_ops['++'], leadingSlash, encoded);
};
var _sporto$erl$Erl$toAbsoluteString = function (url) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_sporto$erl$Erl$pathnameToString(url),
		A2(
			_elm_lang$core$Basics_ops['++'],
			_sporto$erl$Erl$queryToString(url),
			_sporto$erl$Erl$hashToString(url)));
};
var _sporto$erl$Erl$portToString = function (url) {
	var _p4 = url.port_;
	if (_p4.ctor === 'Nothing') {
		return '';
	} else {
...
var _sporto$erl$Erl$hostToString = function (url) {
	return _elm_lang$http$Http$encodeUri(url.host);
};
var _sporto$erl$Erl$protocolToString = function (url) {
...
var _sporto$erl$Erl$toString = function (url) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_sporto$erl$Erl$protocolToString(url),
		A2(
			_elm_lang$core$Basics_ops['++'],
			_sporto$erl$Erl$hostToString(url),
			A2(
				_elm_lang$core$Basics_ops['++'],
				_sporto$erl$Erl$portToString(url),
				_sporto$erl$Erl$toAbsoluteString(url))));
};
var _sporto$erl$Erl$Url = F6(
	function (a, b, c, d, e, f) {
		return {protocol: a, host: b, port_: c, pathname: d, query: e, hash: f};
	});
var _sporto$erl$Erl$parser = A2(
	_elm_tools$parser$Parser_ops['|.'],
	A2(
		_elm_tools$parser$Parser_ops['|='],
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_tools$parser$Parser_ops['|='],
							_elm_tools$parser$Parser$succeed(_sporto$erl$Erl$Url),
							_sporto$erl$Erl$protocolParser),
						_sporto$erl$Erl$hostParser),
					_sporto$erl$Erl$portParser),
				_sporto$erl$Erl$pathnameParser),
			_sporto$erl$Erl_Query$parser),
		_sporto$erl$Erl$hashParser),
	_elm_tools$parser$Parser$end);
var _sporto$erl$Erl$parse = function (input) {
	return A2(_elm_tools$parser$Parser$run, _sporto$erl$Erl$parser, input);
};

var _user$project$DictApp_Dictionary$toStringValue = function (dict) {
	var _p0 = dict;
	switch (_p0.ctor) {
		case 'NO_UK':
			return 'no_uk';
...
var _user$project$DictApp_Dictionary$NO_ME = {ctor: 'NO_ME'};
var _user$project$DictApp_Dictionary$SE_UK = {ctor: 'SE_UK'};
var _user$project$DictApp_Dictionary$UK_SE = {ctor: 'UK_SE'};
var _user$project$DictApp_Dictionary$ES_UK = {ctor: 'ES_UK'};
var _user$project$DictApp_Dictionary$UK_ES = {ctor: 'UK_ES'};
var _user$project$DictApp_Dictionary$FR_UK = {ctor: 'FR_UK'};
var _user$project$DictApp_Dictionary$UK_FR = {ctor: 'UK_FR'};
var _user$project$DictApp_Dictionary$DE_NO = {ctor: 'DE_NO'};
var _user$project$DictApp_Dictionary$NO_DE = {ctor: 'NO_DE'};
var _user$project$DictApp_Dictionary$UK_UK = {ctor: 'UK_UK'};
var _user$project$DictApp_Dictionary$NO_NO = {ctor: 'NO_NO'};
var _user$project$DictApp_Dictionary$UK_NO = {ctor: 'UK_NO'};
var _user$project$DictApp_Dictionary$NO_UK = {ctor: 'NO_UK'};
var _user$project$DictApp_Dictionary$fromString = function (str) {
	var _p2 = str;
	switch (_p2) {
		case 'no_uk':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$NO_UK);
		case 'uk_no':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$UK_NO);
		case 'no_no':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$NO_NO);
		case 'uk_uk':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$UK_UK);
		case 'no_de':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$NO_DE);
		case 'de_no':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$DE_NO);
		case 'uk_fr':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$UK_FR);
		case 'fr_uk':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$FR_UK);
		case 'uk_es':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$UK_ES);
		case 'es_uk':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$ES_UK);
		case 'uk_se':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$UK_SE);
		case 'se_uk':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$SE_UK);
		case 'no_me':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_Dictionary$NO_ME);
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$DictApp_Dictionary$decodeDictionary = function () {
	var decode = function (str) {
		var _p3 = _user$project$DictApp_Dictionary$fromString(str);
		if (_p3.ctor === 'Just') {
			return _elm_lang$core$Json_Decode$succeed(_p3._0);
		} else {
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], 'Unknown dictionary: ', str));
		}
	};
	return A2(_elm_lang$core$Json_Decode$andThen, decode, _elm_lang$core$Json_Decode$string);
}();
var _user$project$DictApp_Dictionary$allDicts = {
	ctor: '::',
	_0: _user$project$DictApp_Dictionary$NO_UK,
	_1: {
		ctor: '::',
		_0: _user$project$DictApp_Dictionary$UK_NO,
		_1: {
			ctor: '::',
			_0: _user$project$DictApp_Dictionary$NO_NO,
			_1: {
				ctor: '::',
				_0: _user$project$DictApp_Dictionary$UK_UK,
				_1: {
					ctor: '::',
					_0: _user$project$DictApp_Dictionary$NO_DE,
					_1: {
						ctor: '::',
						_0: _user$project$DictApp_Dictionary$DE_NO,
						_1: {
							ctor: '::',
							_0: _user$project$DictApp_Dictionary$UK_FR,
							_1: {
								ctor: '::',
								_0: _user$project$DictApp_Dictionary$FR_UK,
								_1: {
									ctor: '::',
									_0: _user$project$DictApp_Dictionary$UK_ES,
									_1: {
										ctor: '::',
										_0: _user$project$DictApp_Dictionary$ES_UK,
										_1: {
											ctor: '::',
											_0: _user$project$DictApp_Dictionary$UK_SE,
											_1: {
												ctor: '::',
												_0: _user$project$DictApp_Dictionary$SE_UK,
												_1: {
													ctor: '::',
													_0: _user$project$DictApp_Dictionary$NO_ME,
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$DictApp_QueryMode$formatQuery = F2(
	function (mode, query) {
		var _p0 = mode;
		switch (_p0.ctor) {
			case 'Prefix':
				return A2(_elm_lang$core$Basics_ops['++'], '^', query);
			case 'Suffix':
				return A2(_elm_lang$core$Basics_ops['++'], query, '$');
			default:
				return query;
...
var _user$project$DictApp_QueryMode$toStringValue = function (mode) {
	var _p1 = mode;
	switch (_p1.ctor) {
		case 'Prefix':
			return 'prefix';
...
var _user$project$DictApp_QueryMode$Regex = {ctor: 'Regex'};
var _user$project$DictApp_QueryMode$Suffix = {ctor: 'Suffix'};
var _user$project$DictApp_QueryMode$Prefix = {ctor: 'Prefix'};
var _user$project$DictApp_QueryMode$fromString = function (str) {
	var _p3 = str;
	switch (_p3) {
		case 'prefix':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_QueryMode$Prefix);
		case 'suffix':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_QueryMode$Suffix);
		case 'regex':
			return _elm_lang$core$Maybe$Just(_user$project$DictApp_QueryMode$Regex);
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$DictApp_QueryMode$decodeQueryMode = function () {
	var decode = function (str) {
		var _p4 = _user$project$DictApp_QueryMode$fromString(str);
		if (_p4.ctor === 'Just') {
			return _elm_lang$core$Json_Decode$succeed(_p4._0);
		} else {
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], 'Unknown queryMode: ', str));
		}
	};
	return A2(_elm_lang$core$Json_Decode$andThen, decode, _elm_lang$core$Json_Decode$string);
}();
var _user$project$DictApp_QueryMode$allQueryModes = {
	ctor: '::',
	_0: _user$project$DictApp_QueryMode$Prefix,
	_1: {
		ctor: '::',
		_0: _user$project$DictApp_QueryMode$Suffix,
		_1: {
			ctor: '::',
			_0: _user$project$DictApp_QueryMode$Regex,
			_1: {ctor: '[]'}
		}
	}
};

var _user$project$DictApp_AppFlags$AppFlags = F3(
	function (a, b, c) {
		return {dictionary: a, queryMode: b, searchQuery: c};
	});
var _user$project$DictApp_AppFlags$decodeAppFlags = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$DictApp_AppFlags$AppFlags,
	A2(_elm_lang$core$Json_Decode$field, 'dictionary', _user$project$DictApp_Dictionary$decodeDictionary),
	A2(_elm_lang$core$Json_Decode$field, 'queryMode', _user$project$DictApp_QueryMode$decodeQueryMode),
	A2(_elm_lang$core$Json_Decode$field, 'queryString', _elm_lang$core$Json_Decode$string));

var _user$project$DictApp_Entry$Entry = F2(
	function (a, b) {
		return {word: a, translations: b};
	});
var _user$project$DictApp_Entry$decodeEntry = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$DictApp_Entry$Entry,
	A2(_elm_lang$core$Json_Decode$field, 'word', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode$field,
		'translations',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
var _user$project$DictApp_Entry$getEntries = F3(
	function (dict, queryMode, searchQuery) {
		return _elm_lang$http$Http$request(
			{
				method: 'GET',
				headers: {ctor: '[]'},
					...
					'/',
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$DictApp_Dictionary$toStringValue(dict),
									_1: {
										ctor: '::',
										_0: A2(_user$project$DictApp_QueryMode$formatQuery, queryMode, searchQuery),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				expect: _elm_lang$http$Http$expectJson(
					_elm_lang$core$Json_Decode$list(_user$project$DictApp_Entry$decodeEntry)),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});

var _user$project$DictApp_List$prevElement = F2(
	function (current, list) {
		var maybeLast = _elm_community$list_extra$List_Extra$last(list);
		var maybeIndex = A2(_elm_community$list_extra$List_Extra$elemIndex, current, list);
		var maybePrev = A2(
			_elm_lang$core$Maybe$andThen,
			function (i) {
				return A2(_elm_community$list_extra$List_Extra$getAt, i - 1, list);
			},
			maybeIndex);
		return A2(
			_elm_lang$core$Maybe$withDefault,
			current,
			A2(_elm_community$maybe_extra$Maybe_Extra$or, maybePrev, maybeLast));
	});
var _user$project$DictApp_List$nextElement = F2(
	function (current, list) {
		var maybeFirst = _elm_lang$core$List$head(list);
		var maybeIndex = A2(_elm_community$list_extra$List_Extra$elemIndex, current, list);
		var maybeNext = A2(
			_elm_lang$core$Maybe$andThen,
			function (i) {
		...
		return A2(
			_elm_lang$core$Maybe$withDefault,
			current,
			A2(_elm_community$maybe_extra$Maybe_Extra$or, maybeNext, maybeFirst));
	});

var _user$project$DictApp_Port$nextDict = _elm_lang$core$Native_Platform.incomingPort(
	'nextDict',
	_elm_lang$core$Json_Decode$succeed(
		{}));
var _user$project$DictApp_Port$prevDict = _elm_lang$core$Native_Platform.incomingPort(
	'prevDict',
	_elm_lang$core$Json_Decode$succeed(
		{}));

var _user$project$DictApp_Program$programWithFlags = F3(
	function (onNavigation, _p0, decodeFlags) {
		var _p1 = _p0;
		var viewWrapper = function (resultModel) {
			var _p2 = resultModel;
			if (_p2.ctor === 'Ok') {
				return _p1.view(_p2._0);
			} else {
				return A2(
		...
		var updateWrapper = F2(
			function (msg, resultModel) {
				var _p3 = resultModel;
				if (_p3.ctor === 'Ok') {
					var _p4 = A2(_p1.update, msg, _p3._0);
					var newModel = _p4._0;
					var cmd = _p4._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Result$Ok(newModel),
						_1: cmd
					};
				} else {
					return {
		...
		var subscriptionsWrapper = function (resultModel) {
			var _p5 = resultModel;
			if (_p5.ctor === 'Ok') {
				return _p1.subscriptions(_p5._0);
			} else {
				return _elm_lang$core$Platform_Sub$none;
			}
		};
		var initWrapper = F2(
			function (flags, location) {
				var _p6 = A2(_elm_lang$core$Json_Decode$decodeValue, decodeFlags, flags);
				if (_p6.ctor === 'Ok') {
					var _p7 = A2(_p1.init, _p6._0, location);
					var model = _p7._0;
					var cmd = _p7._1;
					return {
						ctor: '_Tuple2',
		...
		return A2(
			...
			onNavigation,
			{init: initWrapper, subscriptions: subscriptionsWrapper, update: updateWrapper, view: viewWrapper});
	});

var _user$project$DictApp_Main$entryRow = function (entry) {
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(entry.word),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					A2(_elm_lang$core$List$map, translation, entry.translations)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$DictApp_Main$entriesElement = function (entries) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('entries'),
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$map, _user$project$DictApp_Main$entryRow, entries));
};
var _user$project$DictApp_Main$queryModeDropdownOption = F2(
		...
		return A2(
			_elm_lang$html$Html$option,
			{
				...
				_0: _elm_lang$html$Html_Attributes$value(
					_user$project$DictApp_QueryMode$toStringValue(mode)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$selected(
						_elm_lang$core$Native_Utils.eq(mode, selectedMode)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: _elm_lang$html$Html$text(
					_user$project$DictApp_QueryMode$toStringLabel(mode)),
				_1: {ctor: '[]'}
			});
	});
var _user$project$DictApp_Main$dictDropdownOption = F2(
	function (selectedDict, dict) {
		return A2(
			_elm_lang$html$Html$option,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$value(
					_user$project$DictApp_Dictionary$toStringValue(dict)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$selected(
						_elm_lang$core$Native_Utils.eq(dict, selectedDict)),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					_user$project$DictApp_Dictionary$toStringLabel(dict)),
				_1: {ctor: '[]'}
			});
	});
var _user$project$DictApp_Main$toUrlQuery = function (model) {
	var keepJust = function (_p0) {
		var _p1 = _p0;
		var _p2 = _p1._1;
		if (_p2.ctor === 'Just') {
			return _elm_lang$core$Maybe$Just(
	...
	var ignoreEqual = F2(
		function ($default, value) {
			return _elm_lang$core$Native_Utils.eq($default, value) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(value);
		});
	var maybeDict = A2(
		_elm_lang$core$Maybe$map,
		_user$project$DictApp_Dictionary$toStringValue,
		A2(ignoreEqual, model.appFlags.dictionary, model.dictionary));
	var maybeQueryMode = A2(
		_elm_lang$core$Maybe$map,
		_user$project$DictApp_QueryMode$toStringValue,
		A2(ignoreEqual, model.appFlags.queryMode, model.queryMode));
	var maybeSearchQuery = A2(ignoreEqual, '', model.searchQuery);
	var query = A2(
		_elm_lang$core$List$filterMap,
		keepJust,
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'dict', _1: maybeDict},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'mode', _1: maybeQueryMode},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'query', _1: maybeSearchQuery},
					_1: {ctor: '[]'}
				}
			}
		});
	var url = _sporto$erl$Erl$new;
	var _p3 = query;
	if (_p3.ctor === '[]') {
		return '/';
	} else {
...
var _user$project$DictApp_Main$updateUrl = function (_p4) {
	var _p5 = _p4;
	var _p6 = _p5._0;
	var modifyUrl = _elm_lang$navigation$Navigation$modifyUrl(
		_user$project$DictApp_Main$toUrlQuery(_p6));
	return {
		ctor: '_Tuple2',
		_0: _p6,
...
var _user$project$DictApp_Main$onChangeDictionary = function (tagger) {
	var decoder = A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
		...
		_user$project$DictApp_Dictionary$decodeDictionary);
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(_elm_lang$core$Json_Decode$map, tagger, decoder));
};
var _user$project$DictApp_Main$onChangeQueryMode = function (tagger) {
	var decoder = A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
		...
		_user$project$DictApp_QueryMode$decodeQueryMode);
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(_elm_lang$core$Json_Decode$map, tagger, decoder));
};
var _user$project$DictApp_Main$Model = F5(
	function (a, b, c, d, e) {
		return {appFlags: a, dictionary: b, queryMode: c, searchQuery: d, entries: e};
	});
var _user$project$DictApp_Main$LoadEntries = F2(
	function (a, b) {
		return {ctor: 'LoadEntries', _0: a, _1: b};
	});
var _user$project$DictApp_Main$loadEntries = function (model) {
	var req = A3(_user$project$DictApp_Entry$getEntries, model.dictionary, model.queryMode, model.searchQuery);
	return _elm_lang$core$String$isEmpty(model.searchQuery) ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
		ctor: '_Tuple2',
		_0: model,
		_1: A2(
			_elm_lang$http$Http$send,
			_user$project$DictApp_Main$LoadEntries(model.searchQuery),
			req)
	};
};
var _user$project$DictApp_Main$init = F2(
	function (appFlags, location) {
		var queryDict = function () {
			var _p7 = _sporto$erl$Erl_Query$parse(location.search);
			if (_p7.ctor === 'Ok') {
				return _elm_lang$core$Dict$fromList(_p7._0);
			} else {
				return A2(
		...
		var dictionary = A2(
			...
			_elm_community$maybe_extra$Maybe_Extra$join(
				A2(
					_elm_lang$core$Maybe$map,
					_user$project$DictApp_Dictionary$fromString,
					A2(_elm_lang$core$Dict$get, 'dict', queryDict))));
		var queryMode = A2(
			_elm_lang$core$Maybe$withDefault,
			appFlags.queryMode,
			_elm_community$maybe_extra$Maybe_Extra$join(
				A2(
					_elm_lang$core$Maybe$map,
					_user$project$DictApp_QueryMode$fromString,
					A2(_elm_lang$core$Dict$get, 'mode', queryDict))));
		var searchQuery = A2(
			_elm_lang$core$Maybe$withDefault,
			appFlags.searchQuery,
			A2(_elm_lang$core$Dict$get, 'query', queryDict));
		var initialModel = {
			appFlags: appFlags,
		...
		return _elm_lang$core$String$isEmpty(searchQuery) ? {ctor: '_Tuple2', _0: initialModel, _1: _elm_lang$core$Platform_Cmd$none} : _user$project$DictApp_Main$updateUrl(
			_user$project$DictApp_Main$loadEntries(initialModel));
	});
var _user$project$DictApp_Main$update = F2(
	function (msg, model) {
		var _p8 = msg;
		switch (_p8.ctor) {
			case 'LocationChange':
			...
			case 'SetDictionary':
				return _user$project$DictApp_Main$updateUrl(
					_user$project$DictApp_Main$loadEntries(
						_elm_lang$core$Native_Utils.update(
							model,
							{dictionary: _p8._0})));
			case 'SetQueryMode':
			...
			case 'SetSearchQuery':
				var _p9 = _p8._0;
				return _elm_lang$core$String$isEmpty(_p9) ? _user$project$DictApp_Main$updateUrl(
					{
						ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Platform_Cmd$none
					}) : _user$project$DictApp_Main$updateUrl(
					_user$project$DictApp_Main$loadEntries(
						_elm_lang$core$Native_Utils.update(
							model,
							{searchQuery: _p9})));
			case 'NextDict':
				var dict = A2(_user$project$DictApp_List$nextElement, model.dictionary, _user$project$DictApp_Dictionary$allDicts);
				return _user$project$DictApp_Main$updateUrl(
					_user$project$DictApp_Main$loadEntries(
						_elm_lang$core$Native_Utils.update(
							model,
							{dictionary: dict})));
			case 'PrevDict':
				var dict = A2(_user$project$DictApp_List$prevElement, model.dictionary, _user$project$DictApp_Dictionary$allDicts);
				return _user$project$DictApp_Main$updateUrl(
					_user$project$DictApp_Main$loadEntries(
						_elm_lang$core$Native_Utils.update(
							model,
							{dictionary: dict})));
			default:
				if (!_elm_lang$core$Native_Utils.eq(_p8._0, model.searchQuery)) {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p10 = _p8._1;
					if (_p10.ctor === 'Ok') {
...
var _user$project$DictApp_Main$PrevDict = {ctor: 'PrevDict'};
var _user$project$DictApp_Main$NextDict = {ctor: 'NextDict'};
var _user$project$DictApp_Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$DictApp_Port$nextDict(
				function (_p11) {
					return _user$project$DictApp_Main$NextDict;
				}),
			_1: {
				ctor: '::',
				_0: _user$project$DictApp_Port$prevDict(
					function (_p12) {
						return _user$project$DictApp_Main$PrevDict;
					}),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$DictApp_Main$SetSearchQuery = function (a) {
	return {ctor: 'SetSearchQuery', _0: a};
};
var _user$project$DictApp_Main$queryInputElement = function (model) {
	return A2(
		_elm_lang$html$Html$input,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$placeholder('Query'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$autofocus(true),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value(model.searchQuery),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$DictApp_Main$SetSearchQuery),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$DictApp_Main$SetQueryMode = function (a) {
	return {ctor: 'SetQueryMode', _0: a};
};
var _user$project$DictApp_Main$queryModeDropdown = F2(
	function (selectedMode, modes) {
		return A2(
			_elm_lang$html$Html$select,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('query-dropdown'),
				_1: {
					ctor: '::',
					_0: _user$project$DictApp_Main$onChangeQueryMode(_user$project$DictApp_Main$SetQueryMode),
					_1: {ctor: '[]'}
				}
			},
			A2(
				_elm_lang$core$List$map,
				_user$project$DictApp_Main$queryModeDropdownOption(selectedMode),
				modes));
	});
var _user$project$DictApp_Main$SetDictionary = function (a) {
	return {ctor: 'SetDictionary', _0: a};
};
var _user$project$DictApp_Main$headerTab = F2(
	function (selectedDict, dict) {
		return A2(
			_elm_lang$html$Html$a,
			{
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'header-tab', _1: true},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'is-active',
								_1: _elm_lang$core$Native_Utils.eq(dict, selectedDict)
							},
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$DictApp_Main$SetDictionary(dict)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$DictApp_Main$pageHeader = F2(
	function (model, dicts) {
		var tabs = A2(
			_elm_lang$core$List$map,
			_user$project$DictApp_Main$headerTab(model.dictionary),
			dicts);
		return A2(
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('header-left'),
								_1: {ctor: '[]'}
							},
							tabs),
						_1: {ctor: '[]'}
...
var _user$project$DictApp_Main$dictDropdown = F2(
	function (selectedDict, dicts) {
		return A2(
			_elm_lang$html$Html$select,
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _user$project$DictApp_Main$onChangeDictionary(_user$project$DictApp_Main$SetDictionary),
					_1: {ctor: '[]'}
				}
			},
			A2(
				_elm_lang$core$List$map,
				_user$project$DictApp_Main$dictDropdownOption(selectedDict),
				dicts));
	});
var _user$project$DictApp_Main$queryElement = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_user$project$DictApp_Main$dictDropdown, model.dictionary, _user$project$DictApp_Dictionary$allDicts),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _user$project$DictApp_Main$queryInputElement(model),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$span,
								...
								{
									ctor: '::',
									_0: A2(_user$project$DictApp_Main$queryModeDropdown, model.queryMode, _user$project$DictApp_QueryMode$allQueryModes),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$DictApp_Main$pageBody = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$DictApp_Main$queryElement(model),
			_1: {
				ctor: '::',
				_0: _user$project$DictApp_Main$entriesElement(model.entries),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$DictApp_Main$view = function (model) {
	var prioritizedDicts = A2(_elm_lang$core$List$take, 4, _user$project$DictApp_Dictionary$allDicts);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('dict-app'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(_user$project$DictApp_Main$pageHeader, model, prioritizedDicts),
			_1: {
				ctor: '::',
				_0: _user$project$DictApp_Main$pageBody(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$DictApp_Main$LocationChange = function (a) {
	return {ctor: 'LocationChange', _0: a};
};
var _user$project$DictApp_Main$main = A3(
	_user$project$DictApp_Program$programWithFlags,
	_user$project$DictApp_Main$LocationChange,
	{init: _user$project$DictApp_Main$init, subscriptions: _user$project$DictApp_Main$subscriptions, update: _user$project$DictApp_Main$update, view: _user$project$DictApp_Main$view},
	_user$project$DictApp_AppFlags$decodeAppFlags)(_elm_lang$core$Json_Decode$value);

var Elm = {};
Elm['DictApp'] = Elm['DictApp'] || {};
Elm['DictApp']['Main'] = Elm['DictApp']['Main'] || {};
if (typeof _user$project$DictApp_Main$main !== 'undefined') {
    _user$project$DictApp_Main$main(Elm['DictApp']['Main'], 'DictApp.Main', undefined);
}
